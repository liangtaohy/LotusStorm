...
class DocContentParser:
    ...
    def parse_time(self):
        ...
        pattern1 = re.compile(r"自([12１２][0-9１２３４５６７８９０]{3})年([0-9１２３４５６７８９０]{1,2})月([0-9１２３４５６７８９０]{1,2})日起施行")
        ...
        if match and len(match.groups()) >= 3:
            valid_time = "%s%02d%02d" % (match.groups()[0], int(match.groups()[1]), int(match.groups()[2]))
        ...
        if match2:
            ...
            if match2.group(1) == "公布之日" or match2.group(1) == "发布之日":
        ...
        if len(publish_time) == 0:
            ...
            while pos < total_tokens:
                if debug:
                    print("pos: %d" % pos)
                date_pos = self.find_flags(tokens, ['m', 'm', 'm', 'm', 'm', 'm'], pos)
                if date_pos == -1:
                    break
